...
export const mockRecommendedProducts: RecommendedProduct[] = [
    { id: "rp1", name: "Industrial Ball Bearings", supplierName: "Ningbo Star Hardware", priceRange: "$0.40 - $0.85", minOrder: "500 pcs", verified: true, icon: "cog" },
    { id: "rp2", name: "PVC Pipe Fittings Set", supplierName: "Zhejiang Hexin Plastics Co.", priceRange: "$1.20 - $1.60", minOrder: "200 sets", verified: true, badge: "Trending", icon: "layers" },
    { id: "rp3", name: "Solar Panel Mounting Bracket", supplierName: "Shenzhen Bright LED Co.", priceRange: "$3.00 - $4.50", minOrder: "100 pcs", verified: false, badge: "Hot Deal", icon: "sun" },
    { id: "rp4", name: "Cotton Canvas Roll", supplierName: "Guangzhou Yuetai Textiles", priceRange: "$2.80 - $3.30", minOrder: "50 rolls", verified: true, badge: "New", icon: "package" },
];
